...
export class VerificationStatusChecker {
  ...
  async waitForCompletion() {
    console.log('⏳ [VerificationStatusChecker] Waiting for verification to complete...');
    ...
    while (!verificationSuccess && attempts < maxAttempts) {
      ...
      console.log(`🔄 [VerificationStatusChecker] Verification check attempt ${attempts}/${maxAttempts}, waiting ${waitTime}ms...`);
      ...
      if (verificationSuccess) {
        console.log(`✅ [VerificationStatusChecker] Completed successfully on attempt ${attempts}!`);
        break;
      }
    }
